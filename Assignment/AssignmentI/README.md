...
2. **Course repository**: `11402_CI002`
...
### 3) Write your README in Markdown
In your **course repository**, write a `README.md` that includes:
...
### 4) Publish a GitHub Pages site
**Note:** This task is for your **personal website repository** (recommended: `<username>.github.io`) only.

Enable GitHub Pages for your repository and publish a simple site.
...
### 5) (Optional) Build documentation with Sphinx
If you choose to use Sphinx, add a `docs/` folder (or similar) and record how to build it (commands) in your repository.

---

### 6) Submit
Prepare the following links for submission:
- Your GitHub profile URL: `https://github.com/<username>`
- Your course repository URL: `https://github.com/<username>/11402_CI002`
